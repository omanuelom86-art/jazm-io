...
<input className="bg-transparent border-none focus:ring-0 font-mono text-sm w-full" type="text" value="#006190"/>
</div>
</div>
<div>
...
<pre className="text-xs font-mono opacity-80 whitespace-pre-wrap"><code>&lt;script src="https://cdn.jazm.io/widget.js"&gt;&lt;/script&gt;
&lt;script&gt;
  window.JazmIO.init({
