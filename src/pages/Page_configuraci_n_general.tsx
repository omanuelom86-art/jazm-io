...
<input checked="" className="ml-auto rounded-md text-primary focus:ring-primary border-none bg-white" type="checkbox"/>
</div>
<div className="flex gap-4">
<div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shrink-0">
...
<input className="ml-auto rounded-md text-primary focus:ring-primary border-none bg-white" type="checkbox"/>
</div>
</div>
</div>
