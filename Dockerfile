# FORCE FULL REBUILD: 2026-03-28T19:15:00 (v5.6.3-STABLE)
# REBUILD TRIGGER (Corrected .dockerignore)

FROM atendai/evolution-api:latest

RUN echo "Triggering clean build after .dockerignore correction (Cache Bust 6)..."
